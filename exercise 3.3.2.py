...
# do four squares of the across row, and the terminating '+'
...
# do four squares of the down row, and the terminating '|'
def print_down_row():
    do_four(print_down)
    print('|')
...
# complete grid is four full rows plus a terminating across row
do_four(print_grid_four)
print_across_row()
